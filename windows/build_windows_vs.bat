...
echo   Windows Version (Visual Studio)
echo ==========================================
echo.
...
if not exist "lib\glfw\include\GLFW\glfw3.h" (
    ...
    echo   lib\glfw\lib-vc2022\glfw3.lib
    echo.
    pause
    exit /b 1
)
...
echo [INFO] Dependencies ditemukan!
echo.
...
echo [1/2] Menjalankan CMake untuk Visual Studio...
cmake -G "Visual Studio 17 2022" -A x64 ..
if %ERRORLEVEL% NEQ 0 (
    echo.
    echo [ERROR] CMake gagal!
    echo Pastikan Visual Studio 2022 terinstall dengan C++ tools
    pause
    exit /b 1
)

echo.
echo [2/2] Kompilasi dengan MSBuild...
...
echo ==========================================
echo.
echo Executable: build_win\Release\RoomSimulation3D.exe
echo.
echo Untuk menjalankan, gunakan:
echo   - Double-click windows\run_windows.bat
echo   - Atau jalankan langsung: build_win\Release\RoomSimulation3D.exe
echo.
